...
function getStyles(props, step) {
  ...
  const mergedFloaterProps = (0, import_deepmerge.default)((_a = step == null ? void 0 : step.floaterProps) != null ? _a : {}, floaterProps != null ? floaterProps : {});
  const mergedStyles = (0, import_deepmerge.default)(styles != null ? styles : {}, (_b = step == null ? void 0 : step.styles) != null ? _b : {});
...
var JoyrideOverlay = class extends React2.Component {
  ...
  render() {
    ...
    if (getBrowser() === "safari") {
      ...
      spotlight2 = /* @__PURE__ */ React2.createElement("div", { style: { ...safarOverlay } }, spotlight2);
...
var JoyrideBeacon = class extends React4.Component {
  ...
  render() {
    ...
    const title = import_is_lite4.default.string(locale.open) ? locale.open : (0, import_react_innertext.default)(locale.open);
    const sharedProps = {
      "aria-label": title,
